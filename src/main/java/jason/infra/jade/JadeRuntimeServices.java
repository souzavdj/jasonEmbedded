...
public class JadeRuntimeServices implements RuntimeServicesInfraTier {
    ...
    public String createAgent(String agName, String agSource, String agClass, List<String> archClasses,
        ...
        try {
            if (logger.isLoggable(Level.FINE)) {
                logger.fine("Creating jade agent.asl " + agName + "from source " + agSource + "(agClass=" + agClass
            ...
            logger.log(Level.SEVERE, "Error creating agent.asl " + agName, e);
        }
        return null;
    }
    ...
    public boolean killAgent(String agName, String byAg) {
        try {
            ...
            logger.log(Level.SEVERE, "Error killing agent.asl", e);
        }
        return false;
    }
