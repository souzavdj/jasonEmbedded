...
public class JasonBridgeArch extends AgArch {
    ...
    public void init(AgentParameters ap) throws Exception {
        Agent.create(this, ap.agClass.getClassName(), ap.getBBClass(), ap.asSource.getAbsolutePath(),
                ap.getAsSetts(false, false));
        insertAgArch(this);
    ...
    public List<Literal> perceive() {
        ...
        @SuppressWarnings("rawtypes") List percepts = null;
        try {
        ...
        do {
            try {
                ...
                if (m != null) {
                    ...
                    if (propCont != null) {
                        jason.asSemantics.Message im = new jason.asSemantics.Message(ilForce, sender, getAgName(),
                                propCont, replyWith);
                        if (irt != null) {
                            im.setInReplyTo(irt);
                        }
            ...
            if (irt != null) {
                ...
                if (a != null) {
                    ...
                    logger.log(Level.SEVERE,
                            "Error: received feedback for an Action that is not pending. The message is " + m);
                }
            }
            return true;
        }
