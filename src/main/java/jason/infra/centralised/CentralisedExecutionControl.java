...
public class CentralisedExecutionControl implements ExecutionControlInfraTier {
    ...
    public CentralisedExecutionControl(ClassParameters userControlClass, RunCentralisedMAS masRunner)
    throws JasonException {
        ...
        try {
            ...
            throw new JasonException(
                    "The user execution control class instantiation '" + userControlClass + "' has failed!" + e
                            .getMessage());
        }
    }
