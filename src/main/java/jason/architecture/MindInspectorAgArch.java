...
public class MindInspectorAgArch extends AgArch {
    ...
    protected void setupMindInspector(String configuration) {
        ...
        try {
            ...
            getTS().getLogger().warning("The mindinspector argument does not parse as a predicate! " + configuration
                    + " --  (see Jason FAQ) -- error: " + e);
            return;
        }
    ...
    private void createGUIMindInspector(Structure sConf) {
        ...
        if (mindInspectorFrame == null) { // Initiate the common window
            ...
            mindInspectorFrame.setBounds(100, 200, (int) ((screenSize.width - 100) * 0.7),
                    (int) ((screenSize.height - 100) * 0.9));
