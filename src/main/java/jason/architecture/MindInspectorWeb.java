        ...
        try {
            httpServer.createContext("/agents", new HttpHandler() {
                public void handle(HttpExchange exchange) throws IOException {
                    ...
                    if (requestMethod.equalsIgnoreCase("GET")) {
                        responseBody.write(
                                ("<html><head><title>Jason (list of agents)</title><meta http-equiv=\"refresh\" "
                                        + "content=\""
                                        + refreshInterval + "\" ></head><body>").getBytes());
                        responseBody.write(
                    ...
                    responseBody.write(
                            "<hr/>by <a href=\"http://jason.sf.net\" target=\"_blank\">Jason</a>".getBytes());
