...
public abstract class Literal extends DefaultTerm implements LogicalFormula {
    ...
    /** returns whether this literal is negated or not, use Literal.LNeg and Literal.LPos to compare the returned
     * value */
    ...
    public void addTerm(Term t) {
        logger.log(Level.SEVERE, "addTerm is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
    }

    public void delTerm(int index) {
        logger.log(Level.SEVERE, "delTerm is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
    }

    /** adds some terms and return this */
    public Literal addTerms(Term... ts) {
        logger.log(Level.SEVERE, "addTerms is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return null;
    }
    ...
    public Term getTerm(int i) {
        logger.log(Level.SEVERE, "getTerm(i) is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return null;
    }
    ...
    public Literal setTerms(List<Term> l) {
        logger.log(Level.SEVERE, "setTerms is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return null;
    }

    public void setTerm(int i, Term t) {
        logger.log(Level.SEVERE, "setTerm is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
    }

    // pred
    public Literal setAnnots(ListTerm l) {
        logger.log(Level.SEVERE, "setAnnots is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return null;
    }
    ...
    public boolean addAnnot(Term t) {
        logger.log(Level.SEVERE,
                "addAnnot(" + t + ") is not implemented in the class " + this.getClass().getSimpleName() + " of object "
                        + this, new Exception());
        return false;
    }
    ...
    public Literal addAnnots(Term... terms) {
        logger.log(Level.SEVERE, "addAnnots is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return null;
    }
    ...
    public boolean delAnnot(Term t) {
        logger.log(Level.SEVERE, "delAnnot is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return false;
    }
    ...
    public boolean delAnnots(List<Term> l) {
        logger.log(Level.SEVERE, "delAnnots is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return false;
    }
    ...
    public boolean importAnnots(Literal p) {
        logger.log(Level.SEVERE, "importAnnots is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return false;
    }
    ...
    public void addSource(Term agName) {
        logger.log(Level.SEVERE, "addSource is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
    }

    /** deletes one source(<i>agName</i>) annotation, return true if deleted */
    public boolean delSource(Term agName) {
        logger.log(Level.SEVERE, "delSource is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return false;
    }
    ...
    public void delSources() {
        logger.log(Level.SEVERE, "delSources is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
    }
    ...
    public Literal setNegated(boolean b) {
        logger.log(Level.SEVERE, "setNegated is not implemented in the class " + this.getClass().getSimpleName(),
                new Exception());
        return null;
    }
    ...
    public Iterator<Unifier> logicalConsequence(final Agent ag, final Unifier un) {
        ...
        final int nbAnnots = (hasAnnot() && getAnnots().getTail() == null ? getAnnots().size() :
                              0); // if annots contains a tail (as in p[A|R]), do not backtrack on annots
            ...
            private void get() {
                ...
                if (ruleIt != null) {
                    while (ruleIt.hasNext()) {
                        ...
                        useDerefVars(rhead,
                                ruleUn); // replace vars by the bottom in the var clusters (e.g. X=_2; Y=_2, a(X,Y)
                        // ===> A(_2,_2))
                ...
                while (il.hasNext()) {
                    ...
                    if (belInBB.isRule()) {
                        ...
                        /*if (ag != null && qCache != null && kForChache == null) { // try cache only for the first
                        rule (do not use cache for itself)
