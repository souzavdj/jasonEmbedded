...
public class Include implements Directive {
    ...
    public Agent process(Pred directive, Agent outerContent, Agent innerContent) {
        ...
        try {
            ...
            logger.log(Level.SEVERE,
                    "The included file '" + file + "' was not found! (it is being included in the agent.asl '"
                            + outerContent.getASLSrc() + "')");
        } catch (Exception e) {
    ...
    /** fix path of the asl code based on aslSourcePath, also considers code from a jar file (if urlPrefix is not
     * null) */
