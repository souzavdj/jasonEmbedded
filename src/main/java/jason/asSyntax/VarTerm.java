...
public class VarTerm extends LiteralImpl implements NumberTerm, ListTerm { //, StringTerm, ObjectTerm, PlanBody {
    ...
    public VarTerm(String s) {
        ...
        if (s != null && Character.isLowerCase(s.charAt(0))) {
            logger.warning("Are you sure you want to create a VarTerm that begins with lowercase (" + s
                    + ")? Should it be a Term instead?");
        ...
        if (u != null) {
            ...
            if (vl != null) {
                if (!vl.isCyclicTerm() && vl.hasVar(this, u)) {
                    //logger.warning("The value of a variable contains itself, variable "+super.getFunctor()+"
                    // "+super.getSrcInfo()+", value="+vl+", unifier="+u);
                ...
                //         P[step(N)]
                if (vl.isLiteral() && this
                        .hasAnnot()) { // if this var has annots, add them in the value's annots (Experimental)
    ...
    */
    ...
    /*public boolean setValue(Term vl) {
        if (vl.isVar()) {
            logger.log(Level.WARNING, "Attempted set a variable as a value for a variable, in " + this.getFunctor(),
            new Exception());
            return false;
        }
        ...
        // Answer: use annots of var, useful for meta-programming like
        //         P[step(N)]
        if (vl.isLiteral() && this.hasAnnot()) { // if this var has annots, add them in the value's annots
        (Experimental)
...
*/
    ...
    */
    ...
    public void addTerm(Term t) {
        ...
        logger.log(Level.WARNING, "The addTerm '" + t + "' in " + this + " was lost, since I am a var.",
                new Exception());
    }
    ...
    public Literal setTerms(List<Term> l) {
        /*if (value != null) {
            if (value.isStructure()) {
                ...
                logger.log(Level.WARNING, "The setTerms '"+l+"' in "+this+" was lost, since this var value is not a
                Structure. The value's class is "+getValue().getClass().getName(), new Exception());
                return null;
            }
        } else {*/
        return this;
    ...
    public void setTerm(int i, Term t) {
        /*if (value != null)
            if (value.isStructure())
                ...
                logger.log(Level.WARNING, "The setTerm '"+t+"' in "+this+" was lost, since this var value is not a
                Structure. The value's class is "+getValue().getClass().getName(), new Exception());
                */
    }
    ...
    public Literal addTerms(List<Term> l) {
        /*if (value != null)
            if (value.isStructure())
                ...
                logger.log(Level.WARNING, "The addTerms '"+l+"' in "+this+" was lost, since this var value is not a
                Structure. The value's class is "+getValue().getClass().getName(), new Exception());
                */
        return this;
    }
    ...
    public Literal setAnnots(ListTerm l) {
        if (value != null)
            if (getValue().isPred())
                ...
                logger.log(Level.WARNING, "The setAnnots '"+l+"' in "+this+" was lost, since this var value is not a
                Pred. The value's class is "+getValue().getClass().getName(), new Exception());
        else
    ...
    public boolean importAnnots(Literal p) {
        if (value != null)
            if (getValue().isPred()) {
                ...
                logger.log(Level.WARNING, "The importAnnots '"+p+"' in "+this+" was lost, since this var value is not
                 a Pred. The value's class is "+getValue().getClass().getName(), new Exception());
                return false;
            }
        else
    ...
    public boolean addAnnot(Term t) {
        if (value != null)
            if (getValue().isPred()) {
                ...
                logger.log(Level.WARNING, "The add of annotation '"+t+"' in "+this+" was lost, since this var value
                is not a Pred. The value's class is "+getValue().getClass().getName(), new Exception());
                return false;
            }
        else
    ...
    public Literal addAnnots(List<Term> l) {
        if (value != null)
            if (getValue().isPred()) {
                ...
                logger.log(Level.WARNING, "The addAnnots '"+l+"' in "+this+" was lost, since this var value is not a
                Pred. The value's class is "+getValue().getClass().getName(), new Exception());
                return null;
            }
        else
    ...
    public void addSource(Term t) {
        if (value != null)
            if (getValue().isPred())
                ...
                logger.log(Level.WARNING, "The addSource '"+t+"' in "+this+" was lost, since this var value is not a
                Pred. The value's class is "+getValue().getClass().getName(), new Exception());
        else
            super.addSource(t);
    }
    ...
    */
    ...
    public double solve() throws NoValueException {
        ...
        if (value != null && value.isNumeric())
            ...
            logger.log(Level.SEVERE, getErrorMsg()+" Error getting numerical value of VarTerm " + super.getFunctor()
            + ", the variable value ("+value+") is not a number.", new Exception());
        else
            logger.log(Level.SEVERE, getErrorMsg()+" Error getting numerical value of VarTerm " + super.getFunctor()
            + ", the variable hasn't a value.", new Exception());
        return 0;
        */
    }
