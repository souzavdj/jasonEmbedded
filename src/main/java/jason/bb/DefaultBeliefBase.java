...
public class DefaultBeliefBase implements BeliefBase {
    ...
    public void init(Agent ag, String[] args) {
        if (ag != null) {
            logger = Logger.getLogger(
                    ag.getTS().getUserAgArch().getAgName() + "-" + DefaultBeliefBase.class.getSimpleName());
        }
    }
    ...
    public Iterator<Literal> getPercepts() {
        ...
        return new Iterator<Literal>() {
            ...
            public void remove() {
                if (current == null) {
                    logger.warning("Trying to remove a perception, but the the next() from the iterator is not called "
                            + "before!");
                }
    ...
    protected boolean add(Literal l, boolean addInEnd) {
        ...
        if (bl != null && !bl.isRule()) {
            ...
            l = l.copy(); // we need to clone l for the consequent event to not have a ref to this bel (which may
            // change before the event is processed); see bug from Viviana Marcardi
    ...
    public boolean remove(Literal l) {
        ...
        if (bl != null) {
            if (l.hasSubsetAnnot(bl)) { // e.g. removing b[a] or b[a,d] from BB b[a,b,c]
                ...
                boolean result = bl.delAnnots(
                        l.getAnnots()); // note that l annots can be empty, in this case, nothing is deleted!
    ...
    final class BelEntry {
        ...
        final private Map<LiteralWrapper, Literal> map = new HashMap<LiteralWrapper, Literal>();
        ...
        final class LiteralWrapper {
            ...
            public boolean equals(Object o) {
                return o instanceof LiteralWrapper && l.equalsAsStructure(((LiteralWrapper) o).l);
            }
