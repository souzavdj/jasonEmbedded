...
public class mas2j implements mas2jConstants {
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[]{0x1000, 0x20000000, 0x100, 0xa0000000, 0x7000800, 0x7000800, 0x80000000, 0x0, 0x60000000,
                0x0, 0x60000000, 0x0, 0x78000000, 0x0, 0x78000000, 0x0, 0x0, 0x0, 0x78800000, 0x205a8000, 0x800, 0x200,
                0x800, 0x400, 0x10000000, 0x2000, 0x10000000, 0x4000, 0x20000000, 0x200000,};
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[]{0x0, 0x0, 0x0, 0x0, 0x100, 0x100, 0x0, 0x400, 0x0, 0x400, 0x0, 0x1000, 0x4000, 0x800,
                0x4000, 0x1000, 0x1000, 0x4000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }
    ...
    final public void directives() throws ParseException {
        Token directiveId;
        ClassParameters directiveClass = null;
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case DIRECTIVE:
