...
public class AgentParameters {
    ...
    /**
     * fix source of the asl code based on aslsourcepath, also considers code from a jar file (if urlPrefix is not
     * null)
     */
    ...
    public String getAsInMASProject() {
        ...
        if (agClass != null && agClass.getClassName().length() > 0 && !agClass.getClassName().equals(
                Agent.class.getName())) {
            s.append("agentClass " + agClass + " ");
        }
        if (bbClass != null && bbClass.getClassName().length() > 0 && !bbClass.getClassName().equals(
                DefaultBeliefBase.class.getName())) {
