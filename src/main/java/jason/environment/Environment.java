...
public class Environment {
    ...
    public List<Literal> getPercepts(
            String agName) { // TODO in a future release, call this method doPerception, and get simply returns the list
    ...
    public boolean containsPercept(String agName, Literal per) {
        if (per != null && agName != null) {
            @SuppressWarnings("rawtypes") List agl = (List) agPercepts.get(agName);
            if (agl != null) {
