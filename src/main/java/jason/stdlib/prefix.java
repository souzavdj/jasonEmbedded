 ...
 * <li> <code>.prefix(X,[a,b,c])</code>: unifies X with any prefix of the list, i.e., [a,b,c], [a,b], [a], and [] in
 * this order;
...
public class prefix extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, final Unifier un, Term[] args) throws Exception {
        ...
        final List<Term> list = ((ListTerm) args[1])
                .getAsList(); // use a Java List for better performance in remove last
