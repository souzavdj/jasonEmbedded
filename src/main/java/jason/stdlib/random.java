 ...
 * <li><i>+ quantify of random numbers</i> (number, optional): default value is 1, value = 0 means that an infinify
 * number of random numbers will be produced (this is useful for some backtrack circumstances).</li>
 *
 * </ul>
 *
 * <p>Example:<ul>
 ...
 * <li><code>.random(X, 5)</code>: unifies X with a random number between 0 and 1, and backtracks 5 times. For
 * example: .findall(X, .random(X,5), L) will produce a list of 5 random numbers.</li>
