...
public class time extends DefaultInternalAction {
    ...
    public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        return un.unifies(args[0], new NumberTermImpl(now.get(Calendar.HOUR_OF_DAY))) && un.unifies(args[1],
                new NumberTermImpl(now.get(Calendar.MINUTE))) && un.unifies(args[2],
