...
public class QueryCacheKey {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof QueryCacheKey) {
            ...
            return new Unifier().unifies(this.l, o.l) && o.l.subsumes(
                    this.l); // the compare is here to avoid using p(10,Y) as cache for p(X,Y).
            /*
            if (!o.l.getPredicateIndicator().equals(this.l.getPredicateIndicator())) return false; // compares
            functor & arity
